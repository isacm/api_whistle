...
class Route extends BaseRoute {
    ...
    invokeHandler(requestContext, args) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._handler(...args);
        });
    }
}
exports.Route = Route;
