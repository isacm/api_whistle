...
let RestServer = class RestServer extends context_1.Context {
    ...
    _redirectToSwaggerUI(request, response, options) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._setupHandlerIfNeeded();
            const httpPort = yield this.get(keys_1.RestBindings.PORT);
            const httpHost = yield this.get(keys_1.RestBindings.HOST);
