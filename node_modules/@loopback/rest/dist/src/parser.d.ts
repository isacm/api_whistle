import { OperationArgs, ParsedRequest } from './internal-types';
 ...
 */
export declare function parseOperationArgs(request: ParsedRequest, route: ResolvedRoute): Promise<OperationArgs>;
