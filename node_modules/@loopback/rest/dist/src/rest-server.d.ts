 ...
 * @implements {Server}
 */
export declare class RestServer extends Context implements Server {
    /**
    ...
    protected _handleHttpRequest(request: ServerRequest, response: ServerResponse, options: RestServerConfig): Promise<void>;
